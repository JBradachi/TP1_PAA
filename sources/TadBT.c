...
int mostraVetorResultadoGlobo(TMapa *resultado, int X, int Y, int passo){
    ...
    if (X < 0) X = (resultado->linha)-1;
    if (X >= resultado->linha) X = 0;
    if (Y < 0) Y = (resultado->coluna)-1;
    if (Y >= resultado->coluna) Y = 0;
    ...
    if (resultado->mapa[X+1][Y].passo == passo+1) mostraVetorResultado(resultado, X+1, Y, passo+1);
    else if (resultado->mapa[X][Y+1].passo == passo+1) mostraVetorResultado(resultado, X, Y+1, passo+1);
    else if (resultado->mapa[X-1][Y].passo == passo+1) mostraVetorResultado(resultado, X-1, Y, passo+1);
    else if (resultado->mapa[X][Y-1].passo == passo+1) mostraVetorResultado(resultado, X, Y-1, passo+1);
